...
$first_name = $last_name = $email = $birth_date = $username = $password = $confirm_password = $security_question1 = $security_question2 = $security_answer1 = $security_answer2 = "";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $security_question1 = trim($_POST['security-question1']);
    $security_answer1 = trim($_POST['answer1']);
    $security_question2 = trim($_POST['security-question2']);
    $security_answer2 = trim($_POST['answer2']);
    ...
    if (empty($first_name_err) && empty($last_name_err) && empty($email_err) && empty($birth_date_err) && empty($username_err) && empty($password_err) && empty($confirm_password_err)) {
        ...
        $sql = "INSERT INTO users (first_name, last_name, email, birth_date, username, password, security_question1, security_question2, security_answer1, security_answer2) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";

        if ($stmt = mysqli_prepare($link, $sql)) {
            // Bind variables to the prepared statement as parameters
            mysqli_stmt_bind_param($stmt, "ssssssssss", $param_first_name, $param_last_name, $param_email, $param_birth_date, $param_username, $param_password, $param_security_question1, $param_security_question2, $param_security_answer1, $param_security_answer2);
            ...
            $param_security_question1 = $security_question1;
            $param_security_question2 = $security_question2;
            $param_security_answer1 = $security_answer1;
            $param_security_answer2 = $security_answer2;
    ...
    <div class="wrapper">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" class="needs-validation" method="post" novalidate>
            ...
            <div class="form-group">
                <select name="security-question1" class="form-control input-lg" required>
            ...
            <div class="form-group">
                <input class="form-control input-lg" placeholder="Security Answer" name="answer1" value="" type="text" required>
            </div>

            <div class="form-group">
                <select name="security-question2" class="form-control input-lg" required>
                    <option value="" selected disabled hidden>
                        Security Question
                    </option>
