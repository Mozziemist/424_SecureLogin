    ...
    if(empty($username_err) && empty($password_err)){
	    ...
	    // Set parameters
			...
			if(password_verify($password, $hashed_password)){
			    ...
			    $act_check = "SELECT * FROM users WHERE username = '$username' AND activated = 1 LIMIT 1";
			    $act_result = mysqli_query($link, $act_check);
			    if(mysqli_num_rows($act_result) > 0){
			    ...
			    header("location: welcome.php");
			        ...
			        $activation_err = "Please activate your account before logging in.";
			    }
                        } else{
...
<body>
    <div class="wrapper">
    <div class="alert alert-warning" role="alert"><?php echo $activation_err; ?>
	</div>
        <h2>Login</h2>
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <div class="form-group <?php echo (!empty($password_err)) ? 'has-error' : ''; ?>">
                ...
                <span class="form-text" style="color:red"><?php echo $password_err; ?></span>
            </div>
